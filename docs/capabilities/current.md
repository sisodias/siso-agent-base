...
- Benchmark Research Inbox — `npm run smoke:benchmark-research`
...
- SISO TUI Improvement Catalog — `docs/tui/catalog.md`
- TUI Demo Workbench
- TUI Gallery
- TUI Theme Components
- TUI Workbench Documentation
- OpenTUI App Smoke — `npm run smoke:opentui-app`
