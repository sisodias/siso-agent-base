...
const source = `
import { createSisoOpenTuiRuntime } from "./apps/siso-opentui/src/siso/session-runtime.ts";
...
const runtime = await createSisoOpenTuiRuntime({
...
console.log("SISO_OPENTUI_RUNTIME_SMOKE_OK");
