...
const pack = recordTool("contextPack", contextPack, { cwd: root, query: "flight recorder code intelligence", files: ["docs/flight-recorder/schema.json", "extensions/siso-agent-router/tooling-actions.js"], limit: 2 });
recordFileRead("docs/flight-recorder/schema.json", "contextPack file");
